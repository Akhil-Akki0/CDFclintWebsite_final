        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="max-w-2xl space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <button
                onClick={handleStart}
                className="flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-sky-50 text-[#0369A1] rounded-xl font-bold text-sm shadow-md transition-all active:scale-95 cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-white/20 hover:bg-white/30 text-white border border-white/40 rounded-xl font-semibold text-sm backdrop-blur-sm transition-all active:scale-95 cursor-pointer shadow-xs"
              >
              ...
              <button
                onClick={handleDoc}
                className="flex items-center gap-2 px-4 py-2.5 bg-transparent hover:bg-white/10 text-sky-100 rounded-xl font-medium text-sm transition-colors cursor-pointer"
              >
          ...
          <motion.div
            ...
            className="shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-6 shadow-2xl border-2 border-white/60 flex flex-col items-center text-center max-w-xs text-[#0F172A]"
          >
