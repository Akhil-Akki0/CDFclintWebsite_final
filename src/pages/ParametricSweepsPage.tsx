...
export const ParametricSweepsPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto select-none p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-[#BAE6FD]/70">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700 hover:bg-slate-50 rounded-xl text-xs font-semibold flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer"
          >
          ...
          <button
            ...
            disabled={isSweeping}
            className="px-4 py-2 bg-[#0284C7] hover:bg-[#0369A1] text-white rounded-xl text-xs font-bold transition-all shadow-md flex items-center gap-2 cursor-pointer disabled:opacity-50"
          >
      ...
      <div className="p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-xs grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-xs">
        <div>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {polarData.map((row) => (
                  <tr key={row.aoa} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    <td className="p-3 font-bold text-[#0284C7]">{row.aoa.toFixed(1)}°</td>
