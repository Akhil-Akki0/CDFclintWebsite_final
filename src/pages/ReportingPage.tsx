        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 bg-white rounded-xl border border-[#BAE6FD] text-[#0F172A] text-xs font-bold focus:border-[#0284C7] focus:outline-none shadow-2xs cursor-pointer"
            >
              {simulations.map((sim) => (
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-60 text-white rounded-xl text-xs font-bold shadow-xs transition-all cursor-pointer active:scale-95 shrink-0"
          >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#E2E8F0]">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              onClick={handleDownloadPdf}
              disabled={isGeneratingPdf}
              className="flex items-center gap-2 px-4 py-2 bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-60 text-white rounded-lg text-xs font-semibold shadow-xs transition-all cursor-pointer active:scale-95 shrink-0"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#10B981] hover:bg-[#059669] text-white rounded-lg text-xs font-semibold shadow-xs transition-all cursor-pointer active:scale-95 shrink-0"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 card-bright rounded-2xl border border-[#BAE6FD] p-6 shadow-md space-y-4 relative overflow-hidden">
          ...
          <button
            onClick={handleDownloadPdf}
            disabled={isGeneratingPdf}
            className="w-full py-2 bg-[#2563EB] hover:bg-[#1D4ED8] disabled:opacity-60 text-white rounded-xl text-xs font-bold shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
        ...
        <div className="lg:col-span-7 bg-white rounded-xl border border-[#E2E8F0] p-5 shadow-xs space-y-3">
          ...
          <div className="bg-[#0F172A] text-slate-300 font-mono text-[11px] p-3 rounded-lg max-h-[180px] overflow-y-auto space-y-1">
