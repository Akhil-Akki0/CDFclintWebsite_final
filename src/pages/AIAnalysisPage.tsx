        ...
        <div className="lg:col-span-5 bg-white rounded-xl border border-[#E2E8F0] p-5 shadow-xs space-y-4">
          ...
          <div className="space-y-4 text-xs">
            ...
            <button
              ...
              className="w-full py-2.5 bg-[#8B5CF6] hover:bg-[#7C3AED] disabled:opacity-50 text-white rounded-lg text-xs font-semibold shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer active:scale-95"
            >
              {isPredicting ? (
                <>
