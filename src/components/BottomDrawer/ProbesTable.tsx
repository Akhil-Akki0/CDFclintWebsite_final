...
export const ProbesTable: React.FC<ProbesTableProps> = ({
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto p-2.5 select-none font-mono text-[11px]">
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-[#E2E8F0] text-[10px] text-[#64748B] uppercase tracking-wider bg-[#F8FAFC]">
            <th className="py-1.5 px-2">Probe Identifier</th>
        ...
        <tbody className="divide-y divide-[#E2E8F0] text-[#0F172A] tabular-nums">
          {probes.map((p) => {
            ...
            return (
              ...
              >
                <td className="py-1.5 px-2 flex items-center gap-1.5 font-sans font-semibold">
