  ...
  return (
    <>
      ...
      <div className="absolute top-2.5 left-3 right-3 z-20 flex flex-wrap items-center justify-between gap-2 pointer-events-none">
        ...
        <div className="pointer-events-auto flex items-center bg-white/85 backdrop-blur-md border border-[#E2E8F0]/90 rounded-md p-1 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
        ...
        <div className="pointer-events-auto flex items-center gap-1.5 bg-white/85 backdrop-blur-md border border-[#E2E8F0]/90 rounded-md p-1 shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
          {/* Contours Toggle */}
          <button
      ...
      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-20 pointer-events-auto flex items-center gap-1 bg-white/85 backdrop-blur-md border border-[#E2E8F0]/90 rounded-md px-2 py-1 shadow-[0_2px_8px_rgba(15,23,42,0.06)] text-xs select-none">
