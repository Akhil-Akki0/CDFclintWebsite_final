...
export const LeftSidebar: React.FC<LeftSidebarProps> = ({
  ...
  return (
    <aside className="w-80 md:w-84 lg:w-88 border-r border-[#E2E8F0] bg-white flex flex-col shrink-0 h-full select-none z-10 shadow-[1px_0_3px_rgba(15,23,42,0.02)]">
